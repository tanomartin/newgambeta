        		...
        		<div class="inside">
					...
					<div class="mod_article block" id="register">
						...
						<div class="mod_registration g8 tableform block">
							<form name="form_alta" id="form_alta" action="<?=$_SERVER['PHP_SELF']?>" method="post">
								...
								<div class="formbody">
									<div class="ce_table">
										<fieldset>
											<legend>Datos de Colores</legend>
											<table summary="Personal data">
								  				<tbody>
												    <tr class="even">
												    	<td class="col_0 col_first"><label for="id_opcion">Nombre</label><span class="mandatory">*</span></td>
												        <td class="col_1 col_last"><input name="nombreColor" id="nombreColor" class="required text" maxlength="100"  size="30" type="text" value="<?=$datos[0]["nombreColor"]?>"></td>
												    </tr>
												     <tr class="odd">
												        <td class="col_0 col_first"><label for="id_opcion">R.G.B.</label><span class="mandatory">*</span></td>
												        <td class="col_1 col_last"><input name="rgb" id="rgb" class="required text" size="10" type="color" value="<?=$datos[0]["rgb"]?>"></td>
												    </tr>
												</tbody>
											</table>
										</fieldset>
						...
						<div class="ce_text g4 xpln block">
							<p><strong>Datos de Colores </strong><br/>Ingrese los datos del Arbitro </p>
